...
export const MIN_REQUIRE_AMOUNT_OUT1  = 1000
export const MIN_REQUIRE_AMOUNT_OUT2  =  0.001
export const AMOUNT_SWAP1  = 1
export const AMOUNT_SWAP2  = 1
export const CRON_STRING = "0 * * * * *"
export function setSwap1()
{
  tokenSwap ={
    in: token1,
    amountIn: AMOUNT_SWAP1,
    out: token2,
    poolFee:FeeAmount.MEDIUM,
  }
}

export function setSwap2()
{
  tokenSwap ={
    in: token2,
    amountIn: AMOUNT_SWAP2,
    out: token1,
    poolFee:FeeAmount.MEDIUM,
  }
}
