...
SelfPermit.INTERFACE = /*#__PURE__*/new abi$a.Interface(ISelfPermit.abi);
...
Multicall.INTERFACE = /*#__PURE__*/new abi$a.Interface(IMulticall.abi);
...
Payments.INTERFACE = /*#__PURE__*/new abi$a.Interface(IPeripheryPaymentsWithFee.abi);
...
SwapRouter.INTERFACE = /*#__PURE__*/new abi$a.Interface(ISwapRouter.abi);
...
SwapQuoter.V1INTERFACE = /*#__PURE__*/new abi$a.Interface(IQuoter.abi);
SwapQuoter.V2INTERFACE = /*#__PURE__*/new abi$a.Interface(IQuoterV2.abi);
...
function computePoolAddress(_ref) {
  ...
  return address.getCreate2Address(factoryAddress, solidity.keccak256(['bytes'], [abi$a.defaultAbiCoder.encode(['address', 'address', 'uint24'], [token0.address, token1.address, fee])]), initCodeHashManualOverride != null ? initCodeHashManualOverride : POOL_INIT_CODE_HASH);
}
...
Multicall$1.INTERFACE = /*#__PURE__*/new abi$a.Interface(IMulticall$1.abi);
...
Payments$1.INTERFACE = /*#__PURE__*/new abi$a.Interface(IPeripheryPaymentsWithFee$1.abi);
...
NonfungiblePositionManager.INTERFACE = /*#__PURE__*/new abi$a.Interface(INonfungiblePositionManager);
...
function getProvider() {
  return CurrentWallet.type === exports.WalletType.EXTENSION ? browserExtensionProvider : wallet.provider;
}
function getWalletAddress() {
  return CurrentWallet.type === exports.WalletType.EXTENSION ? walletExtensionAddress : wallet.address;
}
    ...
    return _regeneratorRuntime().wrap(function _callee9$(_context9) {
      while (1) switch (_context9.prev = _context9.next) {
        case 0:
          ...
          _context9.prev = 1;
          _context9.next = 4;
          return fetch(exports.CurrentConfig.API_ROOT + "/api/swap/token/route/v2?network=nos&from_token=" + from + '&to_token=' + to).then(function (res) {
            return res.json();
          });
        case 4:
          res = _context9.sent;
      ...
      while (1) switch (_context5.prev = _context5.next) {
        ...
        case 13:
          ...
          return getSwapTokensV1({
            limit: 500,
            page: 1,
            is_test: exports.CurrentConfig.env == exports.Environment.TESTNET ? '1' : '',
            network: "nos"
          });
        case 16:
          _res = _context5.sent;
    ...
    return _regeneratorRuntime().wrap(function _callee15$(_context15) {
      while (1) switch (_context15.prev = _context15.next) {
        case 0:
          ...
          console.log('No Provider Found');
          return _context15.abrupt("return", exports.TransactionState.Failed);
        case 6:
          _context15.prev = 6;
...
var getTokens = /*#__PURE__*/function () {
  var _ref3 = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(limit) {
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        case 0:
          return _context3.abrupt("return", swrFetcher$1(exports.CurrentConfig.API_ROOT + "/api/token-explorer/tokens?limit=" + limit.toString() + "&network=nos&page=1", {
            method: 'GET',
            error: 'Fail to get tokens data'
          }));
        case 1:
...
var getPositionDetail = /*#__PURE__*/function () {
  var _ref4 = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee4(id) {
    return _regeneratorRuntime().wrap(function _callee4$(_context4) {
      while (1) switch (_context4.prev = _context4.next) {
        case 0:
          return _context4.abrupt("return", swrFetcher$1(exports.CurrentConfig.API_ROOT + "/api/swap-v3/pool/user-position/" + id, {
            method: 'GET',
