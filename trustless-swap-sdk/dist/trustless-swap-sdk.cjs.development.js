...
var MaxUint128 = /*#__PURE__*/ethers.BigNumber.from(2).pow(128).sub(1);
(function (FeeAmount) {
...
SelfPermit.INTERFACE = /*#__PURE__*/new abi$c.Interface(ISelfPermit.abi);
...
Multicall.INTERFACE = /*#__PURE__*/new abi$c.Interface(IMulticall.abi);
...
Payments.INTERFACE = /*#__PURE__*/new abi$c.Interface(IPeripheryPaymentsWithFee.abi);
...
var typeToFee = (_typeToFee = {}, _typeToFee[exports.ETypes.issue] = 1000000, _typeToFee[exports.ETypes.buy] = 1000000, _typeToFee[exports.ETypes.sell] = 1000000, _typeToFee[exports.ETypes.approve] = 60000, _typeToFee[exports.ETypes.update_creator_fee] = 100000, _typeToFee[exports.ETypes.withdraw] = 2100000, _typeToFee[exports.ETypes.createTournament] = 350000, _typeToFee[exports.ETypes.add_watch_list] = 200000, _typeToFee[exports.ETypes.remove_watch_list] = 70000, _typeToFee[exports.ETypes.swap_tokens] = 2000000, _typeToFee[exports.ETypes.transfer] = 10000, _typeToFee[exports.ETypes.swap_eth_key] = 2000000, _typeToFee);
...
var testnetConfig = {
  env: exports.Environment.TESTNET,
  network: "nos",
  swapApi: "swap-v3",
...
var nakatestnetConfig = {
  env: exports.Environment.NAKATESTNET,
  network: "naka",
  swapApi: "swap",
...
var nakamainnetConfig = {
  env: exports.Environment.NAKAMAINNET,
  network: "naka",
  swapApi: "swap",
...
var mainnetConfig = {
  env: exports.Environment.MAINNET,
  network: "nos",
  swapApi: "swap-v3",
...
exports.CurrentConfig = mainnetConfig;
exports.tokenSwap = {
  "in": exports.CurrentConfig.tokens_list[0],
  amountIn: 1,
  out: exports.CurrentConfig.tokens_list[1],
  poolFee: exports.FeeAmount.MEDIUM
};
var tokenLiquidity = {
  token0: exports.CurrentConfig.tokens_list[3],
  token0Amount: 0.5,
  token1: exports.CurrentConfig.tokens_list[4],
  token1Amount: 0.2,
  poolFee: exports.FeeAmount.MEDIUM,
  fractionToRemove: 1,
  fractionToAdd: 0.5
...
function setTOkenIn(inputToken) {
  exports.tokenSwap["in"] = inputToken;
}
function setTOkenOut(outToken) {
  exports.tokenSwap["out"] = outToken;
}
...
function choiceConFig(environment) {
  if (environment == exports.Environment.TESTNET) {
    exports.CurrentConfig = testnetConfig;
  } else if (environment == exports.Environment.MAINNET) {
    exports.CurrentConfig = mainnetConfig;
  } else if (environment == exports.Environment.NAKATESTNET) {
    exports.CurrentConfig = nakatestnetConfig;
  } else if (environment == exports.Environment.NAKAMAINNET) {
    exports.CurrentConfig = nakamainnetConfig;
  }
  resetTOkenSwap();
}
...
var CurrentWallet = {
  address: '',
  privateKey: '',
  type: exports.WalletType.PRIVATEKEY
};
...
var SwapRouter = /*#__PURE__*/function () {
  ...
  SwapRouter.swapCallParameters = function swapCallParameters(trades, options) {
    ...
    var mustRefund = (sampleTrade.inputAmount.currency.isNative || sampleTrade.inputAmount.currency.address.toLowerCase() == exports.CurrentConfig.TC_CONTRACT_ADDRESS.toLowerCase()) && sampleTrade.tradeType === exports.TradeType.EXACT_OUTPUT;
    var inputIsNative = sampleTrade.inputAmount.currency.isNative || sampleTrade.inputAmount.currency.address.toLowerCase() == exports.CurrentConfig.TC_CONTRACT_ADDRESS.toLowerCase();
    // flags for whether funds should be send first to the router
    var outputIsNative = sampleTrade.outputAmount.currency.isNative || sampleTrade.outputAmount.currency.address.toLowerCase() == exports.CurrentConfig.TC_CONTRACT_ADDRESS.toLowerCase();
...
SwapRouter.INTERFACE = /*#__PURE__*/new abi$c.Interface(ISwapRouter.abi);
...
SwapQuoter.V1INTERFACE = /*#__PURE__*/new abi$c.Interface(IQuoter.abi);
SwapQuoter.V2INTERFACE = /*#__PURE__*/new abi$c.Interface(IQuoterV2.abi);
...
function computePoolAddress(_ref) {
  ...
  return address.getCreate2Address(factoryAddress, solidity.keccak256(['bytes'], [abi$c.defaultAbiCoder.encode(['address', 'address', 'uint24'], [token0.address, token1.address, fee])]), initCodeHashManualOverride != null ? initCodeHashManualOverride : POOL_INIT_CODE_HASH);
}
...
var SUPPORTED_CHAINS = [exports.ChainId.MAINNET, exports.ChainId.OPTIMISM, exports.ChainId.OPTIMISM_GOERLI, exports.ChainId.ARBITRUM_ONE, exports.ChainId.ARBITRUM_GOERLI, exports.ChainId.POLYGON, exports.ChainId.POLYGON_MUMBAI, exports.ChainId.GOERLI, exports.ChainId.SEPOLIA, exports.ChainId.CELO_ALFAJORES, exports.ChainId.CELO, exports.ChainId.BNB, exports.ChainId.AVALANCHE, exports.ChainId.BASE_GOERLI, exports.ChainId.NOSTEST, exports.ChainId.NOS];
...
Multicall$1.INTERFACE = /*#__PURE__*/new abi$c.Interface(IMulticall$1.abi);
...
PaymentsNaka.INTERFACE = /*#__PURE__*/new abi$c.Interface(IPeripheryPaymentsWithFee$1.abi);

function fromReadableAmount(amount, decimals) {
  return ethers.ethers.utils.parseUnits(amount.toString(), decimals);
}
function toReadableAmount(rawAmount, decimals) {
  return ethers.ethers.utils.formatUnits(rawAmount, decimals);
}
...
function formatPriceToPriceSqrt(price) {
  ...
  alert("vao day 5");
  var sqrt = ethers.BigNumber.from(new bn(price.toString()).sqrt().multipliedBy(new bn(2).pow(96)).integerValue(3).toString());
  alert("vao day 6");
  return sqrt;
}
...
var NonfungiblePositionManager = /*#__PURE__*/function () {
  ...
  NonfungiblePositionManager.addCallParametersCreate = function addCallParametersCreate(isNewPool, fee, token0, token1, amountADesired, amountBDesired, lowerTick, upperTick, amount0Min, amount1Min, currentPrice, account, deadline) {
    ...
    if (token0.toLowerCase() === exports.CurrentConfig.TC_CONTRACT_ADDRESS.toLowerCase() || token1.toLowerCase() === exports.CurrentConfig.TC_CONTRACT_ADDRESS.toLowerCase()) {
      var wrappedValue = token0.toLowerCase() === exports.CurrentConfig.TC_CONTRACT_ADDRESS.toLowerCase() ? fromReadableAmount(amountADesired, 18) : fromReadableAmount(amountBDesired, 18);
      if (wrappedValue.gt(0)) {
        if (exports.CurrentConfig.env == exports.Environment.NAKAMAINNET || exports.CurrentConfig.env == exports.Environment.NAKATESTNET) {
...
NonfungiblePositionManager.INTERFACE = /*#__PURE__*/new abi$c.Interface(INonfungiblePositionManager);
...
var mainnetProvider = /*#__PURE__*/new ethers.ethers.providers.JsonRpcProvider(exports.CurrentConfig.rpc);
var browserExtensionProvider;
var walletExtensionAddress = null;
function refreshProvider(provider) {
  mainnetProvider = new ethers.ethers.providers.JsonRpcProvider(exports.CurrentConfig.rpc);
  if (CurrentWallet.type == exports.WalletType.PRIVATEKEY && CurrentWallet.privateKey != "") {
    exports.wallet = createWallet();
  } else if (CurrentWallet.type == exports.WalletType.EXTENSION) {
    if (!provider) {
...
function getProvider() {
  return CurrentWallet.type === exports.WalletType.EXTENSION ? browserExtensionProvider : CurrentWallet.privateKey == "" ? mainnetProvider : exports.wallet.provider;
}
function getWalletAddress() {
  return CurrentWallet.type === exports.WalletType.EXTENSION ? walletExtensionAddress : CurrentWallet.privateKey == "" ? "" : exports.wallet.address;
}
...
function _sendTransaction() {
  _sendTransaction = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(transaction) {
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          if (!(CurrentWallet.type === exports.WalletType.EXTENSION)) {
            _context2.next = 6;
            break;
          }
    ...
    return _regeneratorRuntime().wrap(function _callee4$(_context4) {
      while (1) switch (_context4.prev = _context4.next) {
        ...
        case 4:
          ...
          provider = new ethers.ethers.providers.Web3Provider(ethereum);
        case 6:
          _context4.next = 8;
...
function createWallet() {
  ...
  return new ethers.ethers.Wallet(CurrentWallet.privateKey, provider);
}
function createBrowserExtensionProvider() {
  try {
    var _window;
    return new ethers.ethers.providers.Web3Provider((_window = window) == null ? void 0 : _window.ethereum, 'any');
  } catch (e) {
    ...
    return _regeneratorRuntime().wrap(function _callee5$(_context5) {
      while (1) switch (_context5.prev = _context5.next) {
        ...
        case 3:
          ...
          return _context5.abrupt("return", exports.TransactionState.Sent);
        case 9:
          return _context5.abrupt("return", exports.TransactionState.Failed);
        case 10:
          _context5.next = 16;
          break;
        case 12:
          ...
          return _context5.abrupt("return", exports.TransactionState.Rejected);
        case 16:
        case "end":
          return _context5.stop();
      }
    ...
    return _regeneratorRuntime().wrap(function _callee6$(_context6) {
      while (1) switch (_context6.prev = _context6.next) {
        ...
        case 3:
          ...
          console.log("Meta mask receipt ", receipt);
          return _context6.abrupt("return", [exports.TransactionState.Sent, receipt]);
        case 9:
          return _context6.abrupt("return", [exports.TransactionState.Failed, null]);
        case 10:
          _context6.next = 16;
          break;
        case 12:
          ...
          return _context6.abrupt("return", [exports.TransactionState.Rejected, null]);
        case 16:
        case "end":
          return _context6.stop();
      }
    ...
    return _regeneratorRuntime().wrap(function _callee7$(_context7) {
      while (1) switch (_context7.prev = _context7.next) {
        case 0:
          ...
          _context7.next = 3;
          return exports.wallet.sendTransaction(transaction);
        case 3:
          ...
          return _context7.abrupt("return", exports.TransactionState.Failed);
        case 8:
          if (!(receipt === null)) {
            _context7.next = 24;
            break;
        ...
        case 24:
          ...
          return _context7.abrupt("return", exports.TransactionState.Sent);
        case 28:
          return _context7.abrupt("return", exports.TransactionState.Failed);
        case 29:
        case "end":
    ...
    return _regeneratorRuntime().wrap(function _callee8$(_context8) {
      while (1) switch (_context8.prev = _context8.next) {
        ...
        case 4:
          ...
          return _context8.abrupt("return", [exports.TransactionState.Sent, txRes.hash]);
        case 7:
          receipt = null;
          provider = getProvider();
          if (provider) {
          ...
          return _context8.abrupt("return", [exports.TransactionState.Failed, null]);
        case 11:
          if (!(receipt === null)) {
            _context8.next = 27;
            break;
        ...
        case 27:
          ...
          return _context8.abrupt("return", [exports.TransactionState.Sent, receipt]);
        case 31:
          return _context8.abrupt("return", [exports.TransactionState.Failed, null]);
        case 32:
        case "end":
      ...
      while (1) switch (_context.prev = _context.next) {
        ...
        case 3:
          currentPoolAddress = computePoolAddress({
            factoryAddress: exports.CurrentConfig.POOL_FACTORY_CONTRACT_ADDRESS,
            tokenA: tokenIn,
            tokenB: tokenOut,
            fee: poolFee
          });
          poolContract = new ethers.ethers.Contract(currentPoolAddress, IV3PoolABI.abi, provider); //const token0 = await poolContract.token0()
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        ...
        case 3:
          ...
          poolContract = new ethers.ethers.Contract(currentPoolAddress, IV3PoolABI.abi, provider);
          _context2.next = 8;
...
function _getCurrencyBalance() {
  _getCurrencyBalance = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(provider, address, currency) {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          if (!(currency.isNative || currency.address.toLowerCase() == exports.CurrentConfig.TC_CONTRACT_ADDRESS.toLowerCase())) {
            _context.next = 6;
            break;
          }
          _context.t0 = ethers.ethers.utils;
          _context.next = 4;
        ...
        case 6:
          ...
          ERC20Contract = new ethers.ethers.Contract(currency.address, ERC20_ABI, provider);
          _context.next = 9;
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        ...
        case 2:
          ...
          ERC20Contract = new ethers.ethers.Contract(currency.address, ERC20_ABI, provider);
          _context2.next = 6;
          return ERC20Contract.allowance(address, exports.CurrentConfig.SWAP_ROUTER_ADDRESS);
        case 6:
  ...
  _wrapETH = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(eth) {
    ...
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        ...
        case 4:
          wethContract = new ethers.ethers.Contract(exports.CurrentConfig.WETH_CONTRACT_ADDRESS, WETH_ABI, provider);
          transaction = {
            data: wethContract["interface"].encodeFunctionData('deposit'),
            value: ethers.BigNumber.from(Math.ceil(eth)).mul(JSBI.exponentiate(JSBI.BigInt(10), JSBI.BigInt(18)).toString()).toString(),
            from: address,
            to: exports.CurrentConfig.WETH_CONTRACT_ADDRESS,
    ...
    return _regeneratorRuntime().wrap(function _callee4$(_context4) {
      while (1) switch (_context4.prev = _context4.next) {
        ...
        case 4:
          wethContract = new ethers.ethers.Contract(exports.CurrentConfig.WETH_CONTRACT_ADDRESS, WETH_ABI, provider);
          transaction = {
            data: wethContract["interface"].encodeFunctionData('withdraw', [ethers.BigNumber.from(Math.ceil(eth)).mul(JSBI.exponentiate(JSBI.BigInt(10), JSBI.BigInt(18)).toString()).toString()]),
            from: address,
            to: exports.CurrentConfig.WETH_CONTRACT_ADDRESS,
            maxFeePerGas: MAX_FEE_PER_GAS,
            maxPriorityFeePerGas: MAX_PRIORITY_FEE_PER_GAS
...
SwapRouterNaka.INTERFACE = /*#__PURE__*/new abi$c.Interface(ISwapRouter$1.abi);
...
var camelCaseKeys = function camelCaseKeys(obj) {
  if (Boolean(obj) && !lodash.isEmpty(obj) && Array.isArray(obj)) {
    ...
    return _regeneratorRuntime().wrap(function _callee15$(_context15) {
      while (1) switch (_context15.prev = _context15.next) {
        case 0:
          ...
          _context15.prev = 1;
          _context15.next = 4;
          return fetch(exports.CurrentConfig.API_ROOT + ("/api/swap/token/route/v2?network=" + exports.CurrentConfig.chainName + "&from_token=") + from + '&to_token=' + to).then(function (res) {
            return res.json();
          });
        case 4:
          res = _context15.sent;
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          ...
          return _context2.abrupt("return", swrFetcher(exports.CurrentConfig.API_ROOT + "/api/swap/token/list/v1" + qs, {
            method: 'GET',
  ...
  var _ref3 = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(params) {
    ...
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        case 0:
          qs = '?' + new URLSearchParams(params).toString();
          return _context3.abrupt("return", swrFetcher(exports.CurrentConfig.API_ROOT + "/api/swap/token/route/v2" + qs, {
            method: 'GET',
    ...
    return _regeneratorRuntime().wrap(function _callee4$(_context4) {
      while (1) switch (_context4.prev = _context4.next) {
        ...
        case 3:
          ...
          _context4.prev = 6;
          quoteContract = new ethers.ethers.Contract(exports.CurrentConfig.QUOTER_CONTRACT_ADDRESS, QuoterV2ABI.abi, provider);
          _context4.next = 10;
          return quoteContract.connect(provider).callStatic.quoteExactInput(encodePath(addresses, fees), ethers.ethers.utils.parseEther(amountIn.toString()));
        case 10:
        ...
        case 26:
          ...
          break;
        case 28:
          swapRout1 = new Route(listPools, exports.tokenSwap["in"], exports.tokenSwap.out);
          uncheckedTrade = Trade.createUncheckedTrade({
            route: swapRout1,
            inputAmount: CurrencyAmount.fromRawAmount(exports.tokenSwap["in"], fromReadableAmount(exports.tokenSwap.amountIn, exports.tokenSwap["in"].decimals).toString()),
            outputAmount: CurrencyAmount.fromRawAmount(exports.tokenSwap.out, JSBI.BigInt(out)),
    ...
    return _regeneratorRuntime().wrap(function _callee5$(_context5) {
      while (1) switch (_context5.prev = _context5.next) {
        ...
        case 3:
          ...
          quoteContract = new ethers.ethers.Contract(exports.CurrentConfig.QUOTER_CONTRACT_ADDRESS, QuoterV2ABI.abi, provider);
          _context5.next = 12;
          return quoteContract.connect(provider).callStatic.quoteExactOutput(encodePath(addresses, fees), ethers.ethers.utils.parseEther(amountOut.toString()));
        case 12:
        ...
        case 30:
          ...
          uncheckedTrade = Trade.createUncheckedTrade({
            route: swapRout1,
            inputAmount: CurrencyAmount.fromRawAmount(exports.tokenSwap["in"], JSBI.BigInt(input)),
            outputAmount: CurrencyAmount.fromRawAmount(exports.tokenSwap.out, fromReadableAmount(amountOut, exports.tokenSwap["in"].decimals).toString()),
    ...
    return _regeneratorRuntime().wrap(function _callee7$(_context7) {
      while (1) switch (_context7.prev = _context7.next) {
        ...
        case 6:
          ...
          params = {
            from_token: exports.tokenSwap["in"].address,
            to_token: exports.tokenSwap.out.address,
            network: exports.CurrentConfig.network
          };
          _context7.next = 12;
              ...
              return _regeneratorRuntime().wrap(function _callee6$(_context6) {
                while (1) switch (_context6.prev = _context6.next) {
                  ...
                  case 9:
                    ...
                    console.log("quoteExactIn error route,addresses,fees, encodePath(addresses, fees),ethers.utils.parseEther(amountIn.toString()),e", route, addresses, fees, encodePath(addresses, fees), ethers.ethers.utils.parseEther(amountIn.toString()), _context6.t0);
                  case 12:
        ...
        case 39:
          ...
          uncheckedTrade = Trade.createUncheckedTrade({
            route: swapRout1,
            inputAmount: CurrencyAmount.fromRawAmount(exports.tokenSwap["in"], fromReadableAmount(exports.tokenSwap.amountIn, exports.tokenSwap["in"].decimals).toString()),
            outputAmount: CurrencyAmount.fromRawAmount(exports.tokenSwap.out, JSBI.BigInt(result)),
            tradeType: exports.TradeType.EXACT_INPUT
          });
    ...
    return _regeneratorRuntime().wrap(function _callee9$(_context9) {
      while (1) switch (_context9.prev = _context9.next) {
              ...
              return _regeneratorRuntime().wrap(function _callee8$(_context8) {
                while (1) switch (_context8.prev = _context8.next) {
                  ...
                  case 11:
                    ...
                    console.log("quoteExactOutput error route,addresses,fees, encodePath(addresses, fees),ethers.utils.parseEther(amountIn.toString()),e", route, addresses, fees, encodePath(addresses, fees), ethers.ethers.utils.parseEther(amountOut.toString()), _context8.t0);
                  case 14:
        ...
        case 41:
          ...
          uncheckedTrade = Trade.createUncheckedTrade({
            route: swapRout1,
            inputAmount: CurrencyAmount.fromRawAmount(exports.tokenSwap["in"], JSBI.BigInt(result)),
            outputAmount: CurrencyAmount.fromRawAmount(exports.tokenSwap.out, fromReadableAmount(amountOut, exports.tokenSwap["in"].decimals).toString()),
            tradeType: exports.TradeType.EXACT_OUTPUT
          });
    ...
    return _regeneratorRuntime().wrap(function _callee11$(_context11) {
      while (1) switch (_context11.prev = _context11.next) {
        case 0:
          ...
          throw new Error('No provider');
        case 5:
          quoteContract = new ethers.ethers.Contract(exports.CurrentConfig.QUOTER_CONTRACT_ADDRESS, QuoterV2ABINaka.abi, provider);
          listPools = [];
          if (!(swapRoutes.length == 0)) {
            _context11.next = 12;
            break;
              ...
              return _regeneratorRuntime().wrap(function _callee10$(_context10) {
                while (1) switch (_context10.prev = _context10.next) {
                  case 0:
                    ...
                    _context10.prev = 2;
                    _context10.next = 5;
                    return quoteContract.connect(provider).callStatic.quoteExactInput(encodePath(addresses, fees), ethers.ethers.utils.parseEther(amountIn.toString()), useDefiToken);
                  case 5:
                  ...
                  case 9:
                    ...
                    console.log("quoteExactIn error route,addresses,fees, encodePath(addresses, fees),ethers.utils.parseEther(amountIn.toString()),e", route, addresses, fees, encodePath(addresses, fees), ethers.ethers.utils.parseEther(amountIn.toString()), _context10.t0);
                  case 12:
    ...
    return _regeneratorRuntime().wrap(function _callee13$(_context13) {
      while (1) switch (_context13.prev = _context13.next) {
              ...
              return _regeneratorRuntime().wrap(function _callee12$(_context12) {
                while (1) switch (_context12.prev = _context12.next) {
                  case 0:
                    ...
                    _context12.prev = 4;
                    _context12.next = 7;
                    return quoteContract.connect(provider).callStatic.quoteExactOutput(encodePath(addresses, fees), ethers.ethers.utils.parseEther(amountOut.toString()), useDefiToken);
                  case 7:
                  ...
                  case 11:
                    ...
                    console.log("quoteExactOutput error route,addresses,fees, encodePath(addresses, fees),ethers.utils.parseEther(amountIn.toString()),e", route, addresses, fees, encodePath(addresses, fees), ethers.ethers.utils.parseEther(amountOut.toString()), _context12.t0);
                  case 14:
        ...
        case 38:
          ...
          uncheckedTrade = Trade.createUncheckedTrade({
            route: swapRout1,
            inputAmount: CurrencyAmount.fromRawAmount(exports.tokenSwap["in"], JSBI.BigInt(result[0])),
            outputAmount: CurrencyAmount.fromRawAmount(exports.tokenSwap.out, fromReadableAmount(amountOut, exports.tokenSwap["in"].decimals).toString()),
            tradeType: exports.TradeType.EXACT_OUTPUT
          });
    ...
    return _regeneratorRuntime().wrap(function _callee16$(_context16) {
      while (1) switch (_context16.prev = _context16.next) {
        case 0:
          ...
          if (!(!walletAddress && CurrentWallet.type === exports.WalletType.EXTENSION)) {
            _context16.next = 7;
            break;
          }
          _context16.next = 6;
        ...
        case 9:
          ...
          tx = {
            ...
            to: exports.CurrentConfig.SWAP_ROUTER_ADDRESS,
    ...
    return _regeneratorRuntime().wrap(function _callee18$(_context18) {
      while (1) switch (_context18.prev = _context18.next) {
        ...
        case 3:
          quoteContract = new ethers.ethers.Contract(exports.CurrentConfig.QUOTER_CONTRACT_ADDRESS, QuoterV2ABI.abi, provider);
          _context18.next = 6;
          return getListRoute(exports.tokenSwap["in"].address, exports.tokenSwap.out.address);
        case 6:
              ...
              return _regeneratorRuntime().wrap(function _callee17$(_context17) {
                while (1) switch (_context17.prev = _context17.next) {
                  case 0:
                    ...
                    _context17.next = 4;
                    return quoteContract.connect(provider).callStatic.quoteExactInput(encodePath(addresses, fees), ethers.ethers.utils.parseEther(exports.tokenSwap.amountIn.toString()));
                  case 4:
    ...
    return _regeneratorRuntime().wrap(function _callee19$(_context19) {
      while (1) switch (_context19.prev = _context19.next) {
        case 0:
          ...
          newTrade = trade;
          if (!(type == exports.TradeType.EXACT_OUTPUT)) {
            _context19.next = 10;
            break;
          }
          _context19.next = 7;
    ...
    return _regeneratorRuntime().wrap(function _callee23$(_context23) {
      while (1) switch (_context23.prev = _context23.next) {
        case 0:
          ...
          console.log('No Provider Found');
          return _context23.abrupt("return", exports.TransactionState.Failed);
        case 6:
          _context23.prev = 6;
          tokenContract = new ethers.ethers.Contract(token.address, ERC20_ABI, provider);
          _context23.next = 10;
          return tokenContract.populateTransaction.approve(exports.CurrentConfig.SWAP_ROUTER_ADDRESS, fromReadableAmount(amount, token.decimals).toString());
        case 10:
  ...
  var _ref14 = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee14() {
    ...
    return _regeneratorRuntime().wrap(function _callee14$(_context14) {
      while (1) switch (_context14.prev = _context14.next) {
        case 0:
          _rpc = exports.CurrentConfig.rpc;
          if (!_rpc) {
            _context14.next = 7;
            break;
          }
          provider = new ethers.ethers.providers.JsonRpcProvider(_rpc);
          _context14.next = 5;
...
var getDefaultGasPrice = function getDefaultGasPrice() {
  return lodash.random(35, 45) * DEFAULT_GAS_PRICE;
};
...
var getListLiquidity = /*#__PURE__*/function () {
  var _ref2 = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(address) {
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          qs = "?limit=100&network=" + exports.CurrentConfig.chainName + "&page=1&address=" + address;
          return _context2.abrupt("return", swrFetcher$1(exports.CurrentConfig.API_ROOT + "/api/swap/pair/apr/list" + qs, {
            method: 'GET',
...
var getTokens = /*#__PURE__*/function () {
  var _ref3 = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(limit) {
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        case 0:
          return _context3.abrupt("return", swrFetcher$1(exports.CurrentConfig.API_ROOT + "/api/token-explorer/tokens?limit=" + limit.toString() + "&network=" + exports.CurrentConfig.network + "&page=1", {
            method: 'GET',
            error: 'Fail to get tokens data'
          }));
        case 1:
...
var getPositionDetail = /*#__PURE__*/function () {
  var _ref4 = /*#__PURE__*/_asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee4(id) {
    return _regeneratorRuntime().wrap(function _callee4$(_context4) {
      while (1) switch (_context4.prev = _context4.next) {
        case 0:
          return _context4.abrupt("return", swrFetcher$1(exports.CurrentConfig.API_ROOT + "/api/" + exports.CurrentConfig.swapApi + "/pool/user-position/" + id + "?network=" + exports.CurrentConfig.network, {
            method: 'GET',
    ...
    return _regeneratorRuntime().wrap(function _callee5$(_context5) {
      while (1) switch (_context5.prev = _context5.next) {
        ...
        case 7:
          ...
          transaction = {
            data: calldata,
            to: exports.CurrentConfig.NONFUNGIBLE_POSITION_MANAGER_CONTRACT_ADDRESS,
            value: value,
            from: walletAddress
          };
          _context5.next = 11;
    ...
    return _regeneratorRuntime().wrap(function _callee6$(_context6) {
      while (1) switch (_context6.prev = _context6.next) {
        ...
        case 5:
          ...
          return _context6.abrupt("return", exports.TransactionState.Failed);
        case 7:
          // get calldata for increasing a position
    ...
    return _regeneratorRuntime().wrap(function _callee8$(_context8) {
      while (1) switch (_context8.prev = _context8.next) {
        ...
        case 5:
          ...
          return _context8.abrupt("return", exports.TransactionState.Failed);
        case 7:
          // get calldata for increasing a position
    ...
    return _regeneratorRuntime().wrap(function _callee9$(_context9) {
      while (1) switch (_context9.prev = _context9.next) {
        ...
        case 5:
          ...
          return _context9.abrupt("return", exports.TransactionState.Failed);
        case 7:
          // get calldata for increasing a position
    ...
    return _regeneratorRuntime().wrap(function _callee10$(_context10) {
      while (1) switch (_context10.prev = _context10.next) {
        case 0:
          ...
          return _context10.abrupt("return", exports.TransactionState.Failed);
        case 4:
          _context10.next = 6;
    ...
    return _regeneratorRuntime().wrap(function _callee11$(_context11) {
      while (1) switch (_context11.prev = _context11.next) {
        case 0:
          ...
          return _context11.abrupt("return", exports.TransactionState.Failed);
        case 4:
          _context11.next = 6;
  ...
  _getPositionIds = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee12() {
    ...
    return _regeneratorRuntime().wrap(function _callee12$(_context12) {
      while (1) switch (_context12.prev = _context12.next) {
        ...
        case 4:
          positionContract = new ethers.ethers.Contract(exports.CurrentConfig.NONFUNGIBLE_POSITION_MANAGER_CONTRACT_ADDRESS, NONFUNGIBLE_POSITION_MANAGER_ABI, provider); // Get number of positions
          _context12.next = 7;
    ...
    return _regeneratorRuntime().wrap(function _callee13$(_context13) {
      while (1) switch (_context13.prev = _context13.next) {
        case 0:
          ...
          throw new Error('No provider available');
        case 3:
          positionContract = new ethers.ethers.Contract(exports.CurrentConfig.NONFUNGIBLE_POSITION_MANAGER_CONTRACT_ADDRESS, NONFUNGIBLE_POSITION_MANAGER_ABI, provider);
          _context13.next = 6;
    ...
    return _regeneratorRuntime().wrap(function _callee14$(_context14) {
      while (1) switch (_context14.prev = _context14.next) {
        case 0:
          ...
          console.log('No Provider Found');
          return _context14.abrupt("return", exports.TransactionState.Failed);
        case 5:
          _context14.prev = 5;
          tokenContract = new ethers.ethers.Contract(token.address, ERC20_ABI, provider);
          _context14.next = 9;
          return tokenContract.populateTransaction.approve(exports.CurrentConfig.NONFUNGIBLE_POSITION_MANAGER_CONTRACT_ADDRESS, TOKEN_AMOUNT_TO_APPROVE_FOR_TRANSFER);
        case 9:
    ...
    return _regeneratorRuntime().wrap(function _callee16$(_context16) {
      while (1) switch (_context16.prev = _context16.next) {
        case 0:
          ...
          return _context16.abrupt("return", exports.TransactionState.Failed);
        case 4:
          _context16.next = 6;
          return constructPosition(CurrencyAmount.fromRawAmount(tokenLiquidity.token0, fromReadableAmount$1(tokenLiquidity.token0Amount, tokenLiquidity.token0.decimals)), CurrencyAmount.fromRawAmount(tokenLiquidity.token1, fromReadableAmount$1(tokenLiquidity.token1Amount, tokenLiquidity.token1.decimals)));
        case 6:
  ...
  _getEarnedFee = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee17(tokenId) {
    ...
    return _regeneratorRuntime().wrap(function _callee17$(_context17) {
      while (1) switch (_context17.prev = _context17.next) {
        ...
        case 8:
          quoteContract = new ethers.ethers.Contract(exports.CurrentConfig.NONFUNGIBLE_POSITION_MANAGER_CONTRACT_ADDRESS, INonfungiblePositionManager, provider);
          _context17.next = 11;
    ...
    return _regeneratorRuntime().wrap(function _callee18$(_context18) {
      while (1) switch (_context18.prev = _context18.next) {
        ...
        case 5:
          ...
          throw new Error('No provider or address');
        case 8:
          factoryContract = new ethers.ethers.Contract(exports.CurrentConfig.POOL_FACTORY_CONTRACT_ADDRESS, IV3FactoryABI, provider);
          _context18.next = 11;
    ...
    return _regeneratorRuntime().wrap(function _callee19$(_context19) {
      while (1) switch (_context19.prev = _context19.next) {
        ...
        case 5:
          ...
          throw new Error('No provider or address');
        case 8:
          poolContract = new ethers.ethers.Contract(poolAddress, IV3PoolABI.abi, provider);
          _context19.next = 11;
...
exports.CollectFeeeById = CollectFeeeById;
exports.CurrencyAmount = CurrencyAmount;
exports.CurrentWallet = CurrentWallet;
...
exports.MAX_FEE_PER_GAS = MAX_FEE_PER_GAS;
exports.MAX_PRIORITY_FEE_PER_GAS = MAX_PRIORITY_FEE_PER_GAS;
exports.MaxUint128 = MaxUint128;
exports.MaxUint256 = MaxUint256;
exports.NONFUNGIBLE_POSITION_MANAGER_ABI = NONFUNGIBLE_POSITION_MANAGER_ABI;
...
exports.TOKEN_AMOUNT_TO_APPROVE_FOR_TRANSFER = TOKEN_AMOUNT_TO_APPROVE_FOR_TRANSFER;
exports.Tick = Tick;
...
exports.addLiquidityIncludeCreatePool = addLiquidityIncludeCreatePool;
exports.camelCaseKeys = camelCaseKeys;
exports.changeWallet = changeWallet;
exports.choiceConFig = choiceConFig;
exports.computePoolAddress = computePoolAddress;
exports.connectBrowserExtensionWallet = connectBrowserExtensionWallet;
exports.constructPosition = constructPosition;
...
exports.executeTradeAftercheckSlippage = executeTradeAftercheckSlippage;
exports.executeTradeSlippage = executeTradeSlippage;
exports.executeTradeSlippageNaka = executeTradeSlippageNaka;
exports.formatPriceToPriceSqrt = formatPriceToPriceSqrt;
exports.fromReadableAmount = fromReadableAmount;
exports.geSignerAddress = geSignerAddress;
exports.getBestRouteExactIn = getBestRouteExactIn;
exports.getBestRouteExactInNaka = getBestRouteExactInNaka;
exports.getBestRouteExactOut = getBestRouteExactOut;
exports.getBestRouteExactOutNaka = getBestRouteExactOutNaka;
exports.getCurrencyApproveRouter = getCurrencyApproveRouter;
exports.getCurrencyBalance = getCurrencyBalance;
exports.getDefaultGasPrice = getDefaultGasPrice;
exports.getEarnedFee = getEarnedFee;
exports.getGasFee = getGasFee;
exports.getListLiquidity = getListLiquidity;
exports.getListRoute = getListRoute;
exports.getMainnetProvider = getMainnetProvider;
exports.getPoolAddress = getPoolAddress;
exports.getPoolFromAddress = getPoolFromAddress;
exports.getPoolInfo = getPoolInfo;
exports.getPoolInfoByToken = getPoolInfoByToken;
exports.getPositionDetail = getPositionDetail;
exports.getPositionIds = getPositionIds;
exports.getPositionImage = getPositionImage;
exports.getPositionInfo = getPositionInfo;
exports.getProvider = getProvider;
exports.getSwapRoutesV2 = getSwapRoutesV2;
exports.getSwapTokensV1 = getSwapTokensV1;
exports.getTokenTransferApprovalPosition = getTokenTransferApprovalPosition;
exports.getTokenTransferApprovalSwap = getTokenTransferApprovalSwap;
...
exports.nakamainnetConfig = nakamainnetConfig;
exports.nakatestnetConfig = nakatestnetConfig;
exports.nearestUsableTick = nearestUsableTick;
exports.priceToSqrtPrice = priceToSqrtPrice;
exports.reCheckRouteInSlippage = reCheckRouteInSlippage;
exports.reCheckRouteOutSlippage = reCheckRouteOutSlippage;
exports.refreshProvider = refreshProvider;
exports.removeLiquidity = removeLiquidity;
exports.removePosition = removePosition;
exports.resetTOkenSwap = resetTOkenSwap;
exports.sendTransaction = sendTransaction;
exports.sendTransactionGetReceipt = sendTransactionGetReceipt;
exports.sendTransactionViaExtensionGetReceipt = sendTransactionViaExtensionGetReceipt;
exports.setConfig = setConfig;
exports.setTOkenIn = setTOkenIn;
exports.setTOkenOut = setTOkenOut;
exports.setTOkenSwap = setTOkenSwap;
...
exports.tokenLiquidity = tokenLiquidity;
exports.tokenTransferApproval = tokenTransferApproval;
exports.tradeComparator = tradeComparator;
exports.typeToFee = typeToFee;
exports.unwrapETH = unwrapETH;
exports.validateAndParseAddress = validateAndParseAddress;
exports.wrapETH = wrapETH;
//# sourceMappingURL=trustless-swap-sdk.cjs.development.js.map
