...
export declare abstract class NonfungiblePositionManager {
    ...
    static encodeCollectById(tokenId: any, account: any): MethodParameters;
    static encodeIncrease(tokenId: any, amount0Desired: any, amount1Desired: any, amount0Min: any, amount1Min: any, deadline: any): MethodParameters;
    static encodeRemoveLiqidity(tokenId: any, liquidity: any, amount0Min: any, amount1Min: any, deadline: any, account: any): MethodParameters;
    static encodeRemovePosition(tokenId: any): MethodParameters;
    static addCallParametersCreate(isNewPool: Boolean, fee: any, token0: any, token1: any, amountADesired: any, amountBDesired: any, lowerTick: any, upperTick: any, amount0Min: any, amount1Min: any, currentPrice: any, account: any, deadline: any): MethodParameters;
