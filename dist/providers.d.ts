...
export declare let wallet: ethers.Wallet;
...
export declare function sendTransactionGetReceipt(transaction: ethers.providers.TransactionRequest, scanTX?: any): Promise<any>;
